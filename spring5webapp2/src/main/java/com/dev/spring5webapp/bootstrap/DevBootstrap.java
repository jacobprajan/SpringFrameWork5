...
import com.dev.spring5webapp.model.Publisher;
import com.dev.spring5webapp.repositories.AuthorRepository;
import com.dev.spring5webapp.repositories.BookRepository;
import com.dev.spring5webapp.repositories.PublisherRepository;
...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void initData() {
        ...
        Book noEJB = new Book("J2EE Development without EJB", "3456", publisher2);
